        ...
        <div style={{ marginTop: '20px' }} className="flex justify-center">
          ...
          >
            ...
            <select
              ...
              disabled={isReadOnly || submitting || (approvalStatus.isApproved && !isReviewMode)}
              style={{
          ...
          >
            ...
            <div style={{ width: `${dropzoneWidth}px` }} className="flex-shrink-0">
                ...
                disabled={
                  isReadOnly ||
                  submitting ||
                  (approvalStatus.isApproved && !isReviewMode) ||
                  !editPermissions.canUploadFiles ||
                  currentEditingGroup.memoryFiles.length > 0 ||  // 新上傳的檔案
                  (currentEditingGroup.records[0]?.evidenceFiles?.length || 0) > 0  // 已上傳到資料庫的檔案
                }
                readOnly={isReadOnly || submitting || (approvalStatus.isApproved && !isReviewMode)}
                ...
                showFileActions={!isReadOnly && !(approvalStatus.isApproved && !isReviewMode) && editPermissions.canUploadFiles}
                onFileClick={(file) => {
                  if (file.preview) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={isReadOnly || (approvalStatus.isApproved && !isReviewMode)}
