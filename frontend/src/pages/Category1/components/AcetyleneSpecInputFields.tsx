/**
 * AcetyleneSpecInputFields - 乙炔規格輸入欄位組件
 *
 * 包含：
 * - 1 個輸入欄位（規格名稱）
 * - 1 個 FileDropzone（重量證明）
 * - 保存按鈕（在組件內）
 */
...
// ==================== 介面定義 ====================
interface AcetyleneSpecInputFieldsProps {
  spec: AcetyleneSpec
  onFieldChange: (field: keyof AcetyleneSpec, value: any) => void
  onSave: () => void
...
// ==================== 主組件 ====================
export function AcetyleneSpecInputFields({
  spec,
  onFieldChange,
  onSave,
  editingSpecId,
    ...
    <>
      ...
      <div style={{ marginTop: '103px', marginLeft: '367px' }}>
        <div className="flex items-center gap-[29px]">
          <div className="w-[42px] h-[42px] rounded-[10px] flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#9BB944" }}>
      ...
      <div className="flex justify-center" style={{ marginTop: '39px' }}>
        ...
        >
          ...
          <div style={{ marginTop: '40px' }}>
            <h4 style={STYLES.label}>重量證明</h4>
            <p style={STYLES.helperText}>
              如: 有重量資訊的購買單據/ 規格書/ 對話紀錄截圖/ 有公司章的文件等
            </p>
