/**
 * DieselGroupListSection - 柴油頁面資料列表區
 *
 * 包含：
 * - 資料列表標題
 * - 群組列表項目
...
import type { DieselRecord } from '../dieselTypes'
import type { EvidenceFile } from '../../../../api/files'
import type { MemoryFile } from '../../../../services/documentHandler'

export interface DieselGroupListSectionProps {
  savedGroups: DieselRecord[]
...
export function DieselGroupListSection(props: DieselGroupListSectionProps) {
  const {
    savedGroups,
    thumbnails,
    isReadOnly,
