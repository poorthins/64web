/**
 * OtherEnergySourcesSpecInputFields - 其他使用能源規格輸入欄位組件
 *
 * 包含：
 * - 1 個輸入欄位（規格名稱）
...
// ==================== 介面定義 ====================
interface OtherEnergySourcesSpecInputFieldsProps {
  spec: OtherEnergySourcesSpec
  onFieldChange: (field: keyof OtherEnergySourcesSpec, value: any) => void
  onSave: () => void
...
// ==================== 主組件 ====================
export function OtherEnergySourcesSpecInputFields({
  spec,
  onFieldChange,
  onSave,
  editingSpecId,
  ...
  thumbnails,
  onImageClick
}: OtherEnergySourcesSpecInputFieldsProps) {
        ...
        >
          ...
          <div style={{ marginTop: '40px' }}>
            <h4 style={STYLES.label}>
              SDS 安全資料表*/ 重量證明
              <span style={STYLES.subLabel}>
                * 若購買單位為「瓶」、「桶」等描述物品容器或包裝的單位，
                需上傳重量證明，如: 規格書/ 對話紀錄截圖/ 有公司章的文件等。
              </span>
            </h4>
            <FileDropzone
              width="795px"
