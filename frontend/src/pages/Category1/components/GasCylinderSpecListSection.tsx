/**
 * GasCylinderSpecListSection - 氣體鋼瓶規格列表組件
 *
 * 功能：
 * - 顯示已建立的規格列表
 * - 顯示規格照片縮圖
...
// ==================== 介面定義 ====================
interface GasCylinderSpecListSectionProps {
...
// ==================== 主組件 ====================
export function GasCylinderSpecListSection({
  specs,
  thumbnails,
  onEdit,
  onDelete,
  onImageClick,
  isReadOnly
}: GasCylinderSpecListSectionProps) {
