...
// ==================== 介面定義 ====================
interface LPGSpecListSectionProps {
  specs: LPGSpec[]
...
// ==================== 主組件 ====================
export function LPGSpecListSection({
  specs,
  thumbnails,
  onEdit,
  onDelete,
          ...
          return (
            <div
              ...
              style={{
                ...
                background: hasPhoto ? '#F9FAFB' : '#D4F4DD',
                display: 'flex',
                alignItems: 'center',
                paddingLeft: '20px',
                paddingRight: '20px',
